...
var uploadService = function(PAGE, $, LOCALE, YAHOO, sprintf, toHumanSize) {
    "use strict";
    var INITIAL_UPLOAD_STATUS_DELAY = 3e3;
    var UPLOAD_STATUS_INTERVAL = 2e3;
    ...
    function uploadfile(file) {
        ...
        if (supports_XHR2() && supports_FileAPI()) {
            ...
            upload = new UploadViaHiddenIframe({
                id: count,
                uploadkey: PAGE.uploadkey
            });
